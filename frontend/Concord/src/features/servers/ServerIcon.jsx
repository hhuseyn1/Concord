      ...
      <NavLink
        ...
        className={({ isActive }) =>
          cn(
            ...
            'transition-[border-radius] duration-150 [transition-timing-function:var(--ease-standard)]',
            'hover:rounded-2xl',
            ...
            isActive && 'rounded-2xl ring-2 ring-brand ring-offset-2 ring-offset-surface-rail',
          )
        }
      >
        {({ isActive }) => (
